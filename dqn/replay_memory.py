...
from .utils import ABCMeta, SumTree, abstract_attribute
...
class ReplayMemoryPrioritized(ReplayMemory):
    """Prioritized Experience Replay implementation using SumTree."""

    def __init__(self, buffer_size, batch_size, eps_dec):
        """Initializes PER specific parameters."""
    ...
    def store_transitions(self, obses, actions, rews, dones, new_obses):
        """Stores transitions with maximum priority."""
