...
class RLController(SumoEnv):
    """Variant: joint ramp metering + lane-1 VSL control.
    ...
    Lane control is applied to `acceleration_area_1` (mainline lane closest to ramp).
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Observation dim is unchanged (14 macro + grid). Action change does not
        # affect input dimension; only the Q-head width changes.
