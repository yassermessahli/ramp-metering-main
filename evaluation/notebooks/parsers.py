...
def parse_tripinfo_for_episode_stats(tripinfo_path):
    ...
    if not trip_data:
        # Default zero metrics if no trips found
        return {
            "total_throughput": 0,
            "total_travel_time": 0,
            "avg_travel_time": 0,
    ...
    # Aggregate statistics by route type
...
def parse_framework_log(log_path, spillback_threshold=20):
    ...
    # Calculate average detector metrics
    avg_metric_cols = [
